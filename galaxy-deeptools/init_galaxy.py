...
if __name__ == "__main__":
    ...
    if options.docker_build:
        ...
        cmd = 'python ./scripts/api/install_tool_shed_repositories.py --api admin -l http://localhost:8080 --url http://toolshed.g2.bx.psu.edu/ -o bgruening -r f7712a057440 --name deeptools --tool-deps --repository-deps --panel-section-name deepTools'
